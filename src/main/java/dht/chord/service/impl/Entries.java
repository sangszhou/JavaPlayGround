...
package dht.chord.service.impl;


import dht.chord.com.Entry;
 ...
 * {@link } with same {@link} are stored!
 *
...
final class Entries {
     ...
     * @throws NullPointerException If set reference is <code>null</code>.
     */
     ...
     * @throws NullPointerException If entry to add is <code>null</code>.
     */
     ...
     * @throws NullPointerException If entry to remove is <code>null</code>.
     */
     ...
     *
     * @param id ID of entries to be returned.
     * @return Set of matching entries. Empty Set if no matching entries are
     * available.
     * @throws NullPointerException If given ID is <code>null</code>.
     */
     ...
     * upper bound
     *
     * @param fromID Lower bound of IDs; entries matching this ID are NOT included
     *               in result.
     * @param toID   Upper bound of IDs; entries matching this ID ARE included in
     *               result.
     * @return Set of matching entries.
     * @throws NullPointerException If either or both of the given ID references have value
     *                              <code>null</code>.
     */
     ...
     *
     * @param toRemove Set of entries to remove from local hash table.
     * @throws NullPointerException If the given set of entries is <code>null</code>.
     */
