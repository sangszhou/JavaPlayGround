...
import algorithm.classic.SkipList;
import dht.chord.com.CommunicationException;
import dht.chord.com.Entry;
import dht.chord.com.Node;
import dht.chord.com.Proxy;
...
final class References {
     ...
     *
     * @param locID                          ID of local node. Must not be <code>null</code>.
     * @param numberOfEntriesInSuccessorList Length of successor list to be created. Must be greater or
     *                                       equal 1!
     * @param entries                        Reference on this nodes' entries which is passed to creation
     *                                       of the successor list. Must not be <code>null</code>.
     * @throws IllegalArgumentException If any parameters is <code>null</code> or
     ...
     *
     * @param removedReference Node to which the connection shall be closed, if there exists
     ...
     *
     * @param potentialPredecessor Reference on the node to be set as new predecessor; may not be
     *                             null
