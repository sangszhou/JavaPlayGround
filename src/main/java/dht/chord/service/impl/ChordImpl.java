...
public final class ChordImpl implements Chord, Report, AsynChord {
     ...
     *
     * @param bootstrapURL URL of bootstrap node. Must not be null!.
     * @throws ServiceException         If anything goes wrong during the join process.
     * @throws RuntimeException         Length of successor list has not been initialized correctly.
     * @throws IllegalArgumentException <code>boostrapURL</code> is null!
     */
    private final void joinHelp(URL bootstrapURL) throws ServiceException {
        ...
        for (Node newReference : copyOfRefsAndEntries.getRefs()) {
            if (newReference != null && !newReference.equals(this.localNode)
                ...
                if (ChordImpl.this.logger.isEnabledFor(Logger.LogLevel.DEBUG)) {
