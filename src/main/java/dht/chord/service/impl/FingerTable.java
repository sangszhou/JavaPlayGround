...
final class FingerTable {
     ...
     *
     * @param localID    ID of local node.
     * @param references Reference on parent object.
     ...
     * @param proxy Reference to store.
     * @throws ArrayIndexOutOfBoundsException If given index is not contained in the finger table.
     ...
     *
     * @param index Index of entry to be set to <code>null</code>.
     * @throws ArrayIndexOutOfBoundsException If given index is not contained in the finger table.
     */
     ...
     *
     * @param proxy Reference to be added to the finger table.
     * @throws NullPointerException If given reference is <code>null</code>.
     */
     ...
     *
     * @param node1 Reference to be removed from the finger table.
     * @throws NullPointerException If given reference is <code>null</code>.
     */
    ...
    final Node getClosestPrecedingNode(ID key) {
        ...
        for (int i = this.remoteNodes.length - 1; i >= 0; i--) {
            if (this.remoteNodes[i] != null
                    && this.remoteNodes[i].getNodeID().isInInterval(this.localID, key)) {
                if (debug) {
     ...
     * table.
     *
     * @param newReference Reference of which existence shall be determined.
     * @return <code>true</code>, if the given reference exists in the finger
     * table, or <code>false</code>, else.
     * @throws NullPointerException If reference to look for is <code>null</code>.
     */
