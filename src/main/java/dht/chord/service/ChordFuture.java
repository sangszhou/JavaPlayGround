...
public interface ChordFuture {
     ...
     * @throws ServiceException Thrown if the execution has not been successful. Contains the
     ...
     *                              {@link Throwable} that can be obtained by
     *                              {@link #getThrowable()} as cause.
     * @throws InterruptedException Occurs if the thread waiting with help of this method has
     *                              been interrupted.
     */
