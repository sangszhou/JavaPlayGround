...
public interface AsynChord {
     ...
     *
     * @param key      The key for which the associated entries should be retrieved.
     * @param callback The {@link ChordCallback} to which to pass the retrieval
     *                 result.
     */
     ...
     * provided <code>callback</code> instance.
     *
     * @param key      The {@link Key} to associate with <code>entry</code>
     ...
     * provided <code>callback</code> instance.
     *
     * @param key      The {@link Key} associated with <code>entry</code>
     * @param entry    The entry to insert.
     * @param callback The {@link ChordCallback} to which to pass the retrieval
     *                 result.
     */
     ...
     *
     * @param key The {@link Key} for that the associated entries should be
     *            retrieved.
     ...
     *
     * @param key   The {@link Key} with which <code>entry</code> will be
     *              associated.
     * @param entry The entry to insert.
     ...
     *
     * @param key   The {@link Key} with which <code>entry</code> is associated.
