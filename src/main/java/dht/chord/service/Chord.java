...
public interface Chord {
     ...
     *
     * @param nodeURL New {@link URL} of local node.
     * @throws NullPointerException  If given URL reference has value <code>null</code>.
     * @throws IllegalStateException If network has already been created or joined.
     */
     ...
     * before creating or joining a network.
     *
     * @param nodeID New {@link ID} of local node.
     * @throws NullPointerException  If given ID reference has value <code>null</code>.
     * @throws IllegalStateException If network has already been created or joined.
     */
     ...
     * on the node URL.
     *
     * @throws ServiceException Is thrown if creating the local chord node fails, e.g. due to
     ...
     *
     * @param localURL {@link URL} on which this node accepts incoming requests from
     *                 other chord nodes. The {@link ID} of this node is generated by
     *                 applying a hash function on the node {@link URL}.
     * @throws NullPointerException If <code>localURL</code> is <code>null</code>.
     * @throws ServiceException     Is thrown if creating the local chord node fails, e.g. due to
     ...
     * @param localURL {@link URL} on which this node accepts incoming requests from
     *                 other chord nodes.
     * @param localID  {@link ID} of this node.
     * @throws NullPointerException If <code>localURL</code> or <code>localID</code> is
     *                              <code>null</code>.
     * @throws ServiceException     Is thrown if creating the local chord node fails, e.g. due to
     *                              unability of creating the endpoint for incoming messages.
     */
    public abstract void create(URL localURL, ID localID) throws ServiceException;
     ...
     *
     * @param bootstrapURL {@link URL} of one existing node which is used as bootstrap
     *                     node.
     * @throws NullPointerException If <code>bootstrapURL</code> is <code>null</code>.
     * @throws ServiceException     If joining fails this exception is thrown. This may be due to
     ...
     * the node {@link URL}.
     *
     * @param localURL     The local node is made available under this {@link URL}.
     * @param bootstrapURL {@link URL} of one existing node which is used as bootstrap
     *                     node.
     * @throws NullPointerException If <code>localURL</code> or <code>bootstrapURL</code> is
     *                              <code>null</code>.
     * @throws ServiceException     If joining fails this exception is thrown. This may be due to
     *                              failure of establishing an endpoint or communication problems
     *                              when contacting the bootstrap node.
     */
    public abstract void join(URL localURL, URL bootstrapURL) throws ServiceException;
     ...
     * @param bootstrapURL {@link URL} of one existing node which is used as bootstrap
     *                     node.
     * @throws NullPointerException If <code>localURL</code>, <code>localID</code>, or
     *                              <code>bootstrapURL</code> is <code>null</code>.
     * @throws ServiceException     If joining fails this exception is thrown. This may be due to
     *                              failure of establishing an endpoint or communication problems
     *                              when contacting the bootstrap node.
     */
    public abstract void join(URL localURL, ID localID, URL bootstrapURL) throws ServiceException;

    /**
     * Disconnects from the network.
     *
     * @throws ServiceException If properly leaving the network fails this exception is
     ...
     *
     * @param key    Key, under which the new item is stored.
     * @param object Object for storage in the network.
     * @throws NullPointerException If key or object is <code>null</code>.
     * @throws ServiceException     Thrown if insertion failed. The effect of the insertion
     *                              operation is undefined if this exception occurs.
     */
    public abstract void insert(Key key, Serializable object) throws ServiceException;

    /**
     * Attempts to find all objects with given key.
     *
     * @param key Key for which objects shall be retrieved.
     * @return All objects stored under given key. Set of {@link Serializable}
     * @throws NullPointerException If <code>key</code> is <code>null</code>.
     * @throws ServiceException     Is thrown if retrieval failed, e.g. due to a communication
     ...
     *
     * @param key    Key under which the object currently is stored.
     * @param object Object to remove from the network.
     * @throws NullPointerException If key or object is <code>null</code>.
     * @throws ServiceException     Thrown if deletion failed. The effect of the delete operation
     *                              is undefined if this exception occurs.
     */
    public abstract void remove(Key key, Serializable object) throws ServiceException;
