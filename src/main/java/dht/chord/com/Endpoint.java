...
import dht.chord.com.local.ThreadEndpoint;
import dht.chord.com.rmi.RMIEndpoint;
import dht.chord.com.socket.SocketEndpoint;
...
public abstract class Endpoint {
    ...
    /**
     * @param node1 The {@link Node} this is the Endpoint for.
     * @param url1  The {@link URL} that describes the location of this endpoint.
     */
     ...
     *
     * @param s The integer identifying the state to that the endpoint
     ...
     *
     * @param node The node to which this endpoint delegates incoming requests.
     * @param url  The URL under which <code>node</code> will be reachable by
     *             other nodes.
     * @return The endpoint created for <code>node</code> for the protocol
     * specified in <code>url</code>.
     * @throws RuntimeException This can occur if any error that cannot be handled by this
