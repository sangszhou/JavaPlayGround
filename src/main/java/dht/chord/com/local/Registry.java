...
public final class Registry {
     ...
     *
     * @param url   The url of the node that uses the proxy.
     * @param proxy The {@link ThreadProxy proxy}to add.
     */
     ...
     *
     * @param endpoint The {@link ThreadEndpoint}to register.
     */
     ...
     *
     * @param endpoint {@link ThreadEndpoint}to remove.
     */
     ...
     *
     * @param url The url of the node, for which the
