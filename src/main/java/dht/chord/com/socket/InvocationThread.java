...
class InvocationThread implements Runnable {
    ...
    /**
     * @param handler1 Reference to {@link RequestHandler} that started this.
     * @param request1 The {@link Request} that caused this invocation to be started.
     * @param out1     The stream to which to write the result of the invocation.
     */
