 ...
 *                                                                         *
 ***************************************************************************/
package dht.chord.com.socket;

import dht.chord.com.*;
import dht.chord.data.ID;
import dht.chord.data.URL;
import dht.util.logging.Logger;
...
public final class SocketProxy extends Proxy implements Runnable {
     ...
     *
     * ??? 感觉这个写法很奇怪，SocketProxy 是对应一个连接的，为什么还要
     */
    ...
    /**
     * {@link Map} where threads are put in that are waiting for a response.
     ...
     * @param urlOfLocalNode {@link URL} of local node that establishes the connection.
     * @return <code>SocketProxy</code> representing the established
     * connection.
     * @throws CommunicationException Thrown if establishment of connection to <code>url</code>
     *                                failed.
     */
     ...
     *
     * @param url            The {@link URL} of the remote node.
     * @param urlOfLocalNode The {@link URL} of local node.
     * @param nodeID         The {@link ID} of the remote node.
     * @return SocketProxy
     */
     ...
     * @throws CommunicationException while writing to {@link ObjectOutputStream output stream}.
     */
     ...
     * conditions.
     *
     * @param methodIdentifier Integer identifying the method this method is called from.
     ...
     *
     * @param methodIdentifier The identifier of the method to request.
    ...
    public void ping() throws CommunicationException {
        ...
        boolean debugEnabled = SocketProxy.logger.isEnabledFor(Logger.LogLevel.DEBUG);
