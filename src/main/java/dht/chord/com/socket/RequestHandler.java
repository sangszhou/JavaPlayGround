...
import static dht.util.logging.Logger.LogLevel.INFO;
...
final class RequestHandler extends Thread implements EndpointStateListener {
     ...
     *
     * @param node_       The {@link Node node}to delegate requested methods to.
     * @param connection_ The {@link Socket}over which this receives requests.
     * @param ep
     * @throws IOException
     * @throws IOException Thrown if the establishment of a connection over the provided
     *                     socket fails.
     */
     ...
     *
     * @param methodType The type of the method to invoke. See {@link MethodConstants}.
        ...
        switch (methodType) {
            ...
            case MethodConstants.NOTIFY_AND_COPY: {
                ...
                RefsAndEntries refs = this.node.notifyAndCopyEntries(SocketProxy
                        .create(nodeInfo.getNodeURL(), this.node.getNodeURL(), nodeInfo.getNodeID()));
     ...
     *
     * @param method The name of the method to invoke. TODO: change this to another
     *               type.
     */
