...
public abstract class Node {
     ...
     *
     * @return ID of a node.
     * @throws CommunicationException If something goes wrong when contacting the node.
     */
     ...
     *
     * @param key Key for which the successor is searched for.
     * @return Responsible node.
     * @throws CommunicationException Thrown if an unresolvable communication failure occurs.
     */
     ...
     *
     * @param potentialPredecessor Remote node which invokes this method
     ...
     *
     * @param entries The entries that are replicated.
     * @throws CommunicationException Thrown if an unresolvable communication failure occurs.
     */
     ...
     *
     * @param entryToRemove The entry to remove from the dht.
     * @throws CommunicationException Thrown if an unresolvable communication failure occurs.
     */
     ...
     *
     * @param sendingNode      ID of sending node; if entriesToRemove is empty, all replicas
     *                         with ID smaller than the sending node's ID are removed
     * @param replicasToRemove Replicas to remove; if empty, all replicas with ID smaller
